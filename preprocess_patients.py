...
anchorwords = []
for elem in ET.parse('settings.xml').findall('anchors'):
...
if __name__ == "__main__":
    ...
    try:
        ...
        xml_src = sys.argv[2] # "/usr/local/projects/sepsis/data/xml/deid_files.shuffle.xml"
    except:
        print "usage: real_patients.py numPatients srcFile"
        sys.exit()
